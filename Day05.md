...
**Phase 2: Monitor & Operate**

* **04. Monitoring & Logging:** Monitor activity, analyze logs, and detect threats. (Aggregating network and application logs to catch anomalies before they escalate).
* **07. Automation:** Automate security checks and enforce best practices. (Integrating security testing directly into GitHub Actions pipelines so code is checked the moment it is committed).
* **08. Vulnerability Management:** Scan, assess, and fix vulnerabilities regularly to ensure the infrastructure is immune to known exploits.

**Phase 3: Detect & Respond**

* **05. Threat Detection & Response:** Identify threats early and respond to security incidents quickly. (Writing specialized Bash or Python scripts to instantly isolate compromised environments when an alert fires).
* **10. Incident Reporting:** Document incidents and improve security continuously. This is crucial for conducting blameless post-mortems and learning from failures.

**Phase 4: Governance**

* **06. Compliance & Governance:** Ensure policies, standards, and audits are continuously followed so the business meets its legal and regulatory requirements.
